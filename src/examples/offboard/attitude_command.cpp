...
public:
	...
	std::atomic<float> x, y, z, vx, vy, vz, roll, pitch, yaw;
...
private:
	...
	void publish_trajectory_setpoint(float x = 0, float y = 0, float z = 0, float vx = 0, float vy = 0, float vz = 0);
...
void OffboardControl::flight_mode_timer_callback()
{
		...
		//	publish_trajectory_setpoint(x, y, z, vx, vy, vz);
...
void OffboardControl::publish_trajectory_setpoint(float x, float y, float z, float vx, float vy, float vz)
{
...
void OffboardControl::publish_vehicle_attitude_setpoint(float roll, float pitch, float yaw)
{
